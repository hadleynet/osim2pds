...
(def forenames {
  :M '("James" "John" "Robert" "Michael" "William" "David" "Richard" "Charles" "Joseph" 
    ...
    "Benjamin" "Bruce" "Brandon" "Adam" "Harry" "Fred" "Wayne" "Billy" "Steve" "Louis" 
    "Jeremy" "Aaron" "Randy" "Howard" "Eugene" "Carlos" "Russell" "Bobby" "Victor" 
    ...
    "Jordan" "Ian" "Wallace" "Ken" "Bob" "Jaime" "Casey" "Alfredo" "Alberto" "Dave" 
  ...
  :F '("Mary" "Patricia" "Linda" "Barbara" "Elizabeth" "Jennifer" "Maria" "Susan" 
    ...
    "Rita" "Dawn" "Connie" "Florence" "Tracy" "Edna" "Tiffany" "Carmen" "Rosa" "Cindy"
    "Grace" "Wendy" "Victoria" "Edith" "Kim" "Sherry" "Sylvia" "Josephine" "Thelma"
    "Shannon" "Sheila" "Ethel" "Ellen" "Elaine" "Marjorie" "Carrie" "Charlotte" "Monica"
    "Esther" "Pauline" "Emma" "Juanita" "Anita" "Rhonda" "Hazel" "Amber" "Eva" "Debbie"
    "April" "Leslie" "Clara" "Lucille" "Jamie" "Joanne" "Eleanor" "Valerie" "Danielle"
    "Megan" "Alicia" "Suzanne" "Michele" "Gail" "Bertha" "Darlene" "Veronica" "Jill"
    "Erin" "Geraldine" "Lauren" "Cathy" "Joann" "Lorraine" "Lynn" "Sally" "Regina" "Erica"
    "Beatrice" "Dolores" "Bernice" "Audrey" "Yvonne" "Annette" "June" "Samantha" "Marion"
    "Dana" "Stacy" "Ana" "Renee" "Ida" "Vivian" "Roberta" "Holly" "Brittany" "Melanie"
    ...
    "Lucy" "Tonya" "Ella" "Stacey" "Wilma" "Gina" "Kristin" "Jessie" "Natalie" "Agnes"
    ...
    "Courtney" "Marian" "Stella" "Caroline" "Dora" "Jo" "Vickie" "Mattie" "Terry" "Maxine"
...
(def surnames '("Smith" "Johnson" "Williams" "Jones" "Brown" "Davis" "Miller" "Wilson" 
  ...
  "Banks" "Meyer" "Bishop" "Mccoy" "Howell" "Alvarez" "Morrison" "Hansen" "Fernandez"
  ...
  "Hanson" "Day" "Mendoza" "Moreno" "Bowman" "Medina" "Fowler" "Brewer" "Hoffman"
  ...
  "Newman" "Haynes" "Mcdaniel" "Mendez" "Bush" "Vaughn" "Parks" "Dawson" "Santiago"
  ...
  "Swanson" "Joseph" "Francis" "Goodman" "Maldonado" "Yates" "Becker" "Erickson" "Hodges"
  "Rios" "Conner" "Adkins" "Webster" "Norman" "Malone" "Hammond" "Flowers" "Cobb" "Moody"
  "Quinn" "Blake" "Maxwell" "Pope" "Floyd" "Osborne" "Paul" "Mccarthy" "Guerrero"
...
(defn surname [] (rand-nth surnames))

(def streetnames '("Park" "Main" "Oak" "Pine" "Maple" "Cedar" "Elm" "Lake" "Hill" "Second"
  "Washington"))
  
(defn street [] (format "%d %s Street" (+ 1 (rand-int 2000)) (rand-nth streetnames)))
